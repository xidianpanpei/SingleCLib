...
static void rotate_left(BiTreeNode **node)
{
    ...
    else
    {
        ...
        switch(((AvlNode *)bitree_data(grandchild))->factor)
        {
           ...
           case AVL_RGT_HEAVY:
               ((AvlNode *)bitree_date(*node))->factor = AVL_BALANCED;
...
static void destroy_left(BisTree *tree, BiTreeNode *node)
{
    ...
    // Determin where to destroy nodes.
    if(node == NULL)
    {
        position = &tree->root;
    }
    ...
    if(*position != NULL)
    {
        ...
        {
            // Call a user-defined function to free dynamically a llocated data.
    ...
    else
    {
        ...
        else
        {
            ...
            else
            {
                ...
                if(tree->destroy != NULl)
                {
                    // Destroy the hidden data since it si being replaced.
